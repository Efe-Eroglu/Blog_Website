            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="detail-box">
                        ...
                        <a href="Bloglar.aspx">Okumaya Başla
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="contact_form">
                        <asp:TextBox ID="isim" placeholder="İsim" runat="server"></asp:TextBox>
                        <asp:TextBox ID="txtEmail" placeholder="Email" runat="server" TextMode="Email"></asp:TextBox>
                        <input type="text" id="mesaj" placeholder="Mesaj" class="message_input" name="mesaj">
                        <br />
                        <asp:Button ID="Button1" runat="server" CssClass="button" Text="Gönder" OnClick="Button1_Click" />
